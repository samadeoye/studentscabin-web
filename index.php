        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="image-layer"
                    style="background-image: url(assets/images/backgrounds/banner1.jpg);">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7">
                            <div class="main-slider__content">
                                <h2><span style="font-size:25px;">Welcome to</span><br> Students<span><span style="font-size:45px">Cabin</span></span></h2>
                                <p>Students' Oasis of Support, Harbor of Hope!</p>
            ...
            <div class="swiper-slide">
                <div class="image-layer"
                    style="background-image: url(assets/images/backgrounds/banner2.jpg);">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7">
...
<section class="we-believe">
    ...
    <div class="container">
        <div class="section-title text-center">
            <span class="section-title__tagline">StudentsCabin</span>
            <h2>We believe in the power of education to transform lives</h2>
            <p>Our mission is to create a nurturing environment where students can thrive academically, personally, and professionally. Through innovative programs, collaborative partnerships, and community engagement initiatives, we empower students with the resources, guidance, and support they need to overcome challenges, realize their full potential, and create a better future for themselves and their communities.</p>
            <a href="about" class="thm-btn2 welcome-one__btn">Discover More</a>
        </div>
    </div>
</section>

<!--Student Community CTA Start-->
<section class="fundraishing">
    <div class="fundraishing-bg-box">
        <div class="fundraishing-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
            style="background-image: url(assets/images/backgrounds/community.jpg);"></div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="fundraishing__inner">
                    <p class="fundraishing__sub-title">Are you a student?</p>
                    <h2 class="fundraishing__title">Join our student community</h2>
                    <div class="fundraishing__btn-box">
                        <a href="participate?id=studentRegistration" class="thm-btn fundraishing__btn">Join now</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <ul class="list-unstyled we-believe__list">
                    <li class="we-believe__single wow fadeInUp" data-wow-delay="200ms">
                        <div class="we-believe__icon">
                            <span><i style="font-size:45px;" class="fas fa-hand-holding-usd"></i></span>
                        </div>
                        <h3 class="we-believe__title"><a href="javascript:0;">Emergency Financial Assistance (Urgent 2k)</a></h3>
                        <p class="we-believe__text">In times of urgent need, we provide emergency financial assistance of ₦2,000 to students facing unforeseen financial hardships</p>
                    </li>
                    <li class="we-believe__single wow fadeInUp" data-wow-delay="300ms">
                        <div class="we-believe__icon">
                            <span class=""><i style="font-size:45px;" class="fas fa-wifi"></i></span>
                        </div>
                        <h3 class="we-believe__title"><a href="javascript:0;">Weekly Mobile Data Giveaways</a></h3>
                        <p class="we-believe__text">We understand the importance of staying connected in today's digital world. That's why we offer weekly mobile data giveaways to ensure that students have access to online resources, educational materials, and support services</p>
                    </li>
                    <li class="we-believe__single wow fadeInUp" data-wow-delay="400ms">
                        <div class="we-believe__icon">
                            <span><i style="font-size:45px;" class="fas fa-hand-holding-heart"></i></span>
                        </div>
                        <h3 class="we-believe__title"><a href="javascript:0;">Mini Scholarships for Tuition Support</a></h3>
                        <p class="we-believe__text">We offer mini scholarships to provide tuition support for students facing financial barriers to education</p>
                    </li>
                </ul>
            </div>
            <div class="col-xl-12 text-center">
                <a href="services" class="thm-btn welcome-one__btn">Discover More</a>
            </div>
        </div>
    </div>
</section>
...
<!--CTA One Start-->
<section class="cta-one cta-one_style2 mb-5">
        ...
        <div class="row text-center">
            <div class="col-xl-12">
                <div class="pb-3">
                    ...
                    <h2 class="text-white">We believe in the power of collaboration and partnership to maximize our impact and reach</h2>
                </div>
                <div>
                    <a href="partnership" class="thm-btn2 cta-one__btn">partner</a>
                </div>
            </div>
        </div>
    </div>
...
<!--Team Start-->
<section class="volunteers-one volunteers--carousel">
    <div class="container">
        <div class="section-title text-center">
            <span class="section-title__tagline">Ready to help you</span>
            <h2>Our Team</h2>
        </div>
        <div class="thm-owl__carousel volunteers__carousel carousel--have-shadow owl-carousel" data-owl-options='{
            "loop": true,
            "margin": 30,
            "items": 1,
            "nav": true,
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-xl-12">
                <div class="pb-3">
                    <div class="text-white" style="font-size:50px;">
                        <span class="fas fa-hand-holding-usd"></i></span>
                    </div>
                    <h2 class="text-white">Join us on our mission to empower and support students in Nigeria</h2>
                </div>
                <div>
                    <a href="donation" class="thm-btn cta-one__btn">donate/support</a>
                </div>
            </div>
        </div>
    </div>
