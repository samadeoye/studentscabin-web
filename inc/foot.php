            ...
            <div class="row">
                <div class="col-md-3 wow fadeInUp" data-wow-delay="100ms">
                    <div class="footer-widget__column footer-widget__about">
                        <div class="footer-widget__about-text-box">
                            <a href="<?php echo DEF_ROOT_PATH; ?>"><img style="height:100px;" src="assets/images/resources/logoWhite1.png" alt=""></a>
                            <p class="text-white">We believe in the power of education to transform lives</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 wow fadeInUp" data-wow-delay="300ms">
                    <div class="footer-widget__column footer-widget__non-profit clearfix">
                        <h3 class="footer-widget__title">Participate</h3>
                        <ul class="footer-widget__non-profit-list list-unstyled clearfix">
                            <li><a href="participate?id=studentRegistration">Join Student Community</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        <p class="site-footer__bottom-text">© Copyright <?php echo date('Y'); ?> by <a href="https://wa.me/2349034770998">S-WEB</a>
                        </p>
...
<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        ...
        <div class="logo-box">
            <a href="<?php echo DEF_ROOT_PATH; ?>"><img style="height:70px;" src="assets/images/resources/logoWhite1.png" alt=""></a>
        </div>
        <!-- /.logo-box -->
